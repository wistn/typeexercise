/* pinyin/docs/browser.js May 24, 2017|@creeperyang|github.com/creeperyang/pinyin/blob/master/LICENSE
 * 库原说明：不支持多音字；ie/edge 测试未通过。
 */

var pinyin = (function (N, A) {
    return A();
...
// console.log(pinyin.convertToPinyin('事中比较令人瞩目的一件发生在俄亥俄州哥伦布市我有几个朋友家在那儿遗', '-', true));
